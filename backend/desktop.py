"""Launcher desktop Windows per Eye Supremo / RandFatture.

Compilato con PyInstaller in EyeSupremo.exe: avvia FastAPI sulla porta 8765,
serve il frontend buildato e apre il browser quando il server è pronto.
"""
...
def main() -> None:
    # Dati e .env sotto %LOCALAPPDATA%\EyeSupremo quando è un exe.
